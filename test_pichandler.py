...
class TestPicHandler(unittest.TestCase):
    ...
    def test_picture_check(self):
        ...
        self.assertTrue(
            pichandler.picture_check(pictures_folder / Path(pictureID + '.tga'), pictureID, pictures_folder))
        ...
        self.assertFalse(
            pichandler.picture_check(pictures_folder / Path(pictureID + '.txt'), pictureID, pictures_folder))
        self.assertFalse(
            pichandler.picture_check(pictures_folder / Path(pictureID + '.pdf'), pictureID, pictures_folder))
